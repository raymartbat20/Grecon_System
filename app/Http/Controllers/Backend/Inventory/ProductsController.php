...
class ProductsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.inventory.products.products',compact('products','archive'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.inventory.products.addProduct',compact('categories','suppliers'));
    }
    ...
    public function edit($product_id)
    {
        ...
        return view('backend.inventory.products.editProduct',compact('categories','suppliers','product','status'));
    }
    ...
    public function update(Request $request, $product_id)
    {
        ...
        return redirect(route('backend.inventory.products.index'))->with($notification);
    }
    ...
    public function archiveProducts()
    {
        ...
        return view('backend.inventory.products.archiveProducts',compact('products'));
    }
    ...
    public function addStocks(Request $request)
    {
        ...
        if($product->own_product == 1)
        {
            ...
            return redirect()->action('Backend\inventory\ProductsController@requirements');
        }
    ...
    public function requirements()
    {
        ...
        return view('backend.inventory.products.requirements',compact('items','adding_stocks','product_id'));
    }
    ...
    public function productLog($product_id)
    {
        ...
        return view('backend.inventory.products.productLog',compact('product','defectives','addStocks','product_name','materials'));
    }
}
