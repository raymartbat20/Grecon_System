...
@section('content')
    <div class="col-lg-12 grid-margin stretched-card">
        <div class="card">
            <div class="card-body">
                <a href="{{route('backend.inventory.products.index')}}" class="btn btn-info pull-right">Go Back</a>
    ...
    <div class="modal fade" id="restore-product" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-center modal-default">
            <form method="POST" action="{{route('backend.inventory.products.restoreProduct')}}">
                @csrf
