...
@section('content')
    ...
    <div class="modal fade" id="reduce-material" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-default">
            <form method="GET" action="{{route('backend.inventory.createproduct.reduceMaterial')}}">
                @csrf
    ...
    <div class="modal fade" id="remove-material" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-default">
                <form method="GET" action="{{route('backend.inventory.createproduct.removeMaterial')}}">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
