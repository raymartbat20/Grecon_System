...
@section('content')
    ...
    <div class="modal fade" tabindex="-1" id="edit-supplier" aria-hidden="true" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('backend.inventory.suppliers.update','test')}}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
    ...
    <div class="modal fade" id="confirm-delete-supplier" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{route('backend.inventory.suppliers.destroy','delete')}}">
                        @csrf
                        @method('DELETE')
                        <div class="modal-header">
