        ...
        <div class="card px-2">
            <div class="card-body">
                ...
                <div class="container-fluid w-100">
                  <a href="{{route('backend.cashier.transaction.printInvoice',[$customer->customer_id])}}" target="_blank" class="btn btn-primary float-right mt-4 ml-2"><i class="mdi mdi-printer mr-1"></i>Print</a>
                </div>
            </div>
        </div>
    </div>
