                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <a href="{{url('/cashier/cart/cart_items')}}" class="btn btn-outline-info form-control">Items: 
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <form method="GET" action="{{route('backend.cashier.transaction.index')}}">
    ...
    <!-- modal -->
        <div class="modal fade" id="add-qty-pc" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-center modal-default">
                <form method="GET" action="{{route('backend.cashier.ordercart.addToCart')}}" id="#add-form-pc">
                    @csrf
        ...
        <div class="modal fade" id="add-qty-kilo" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-center modal-default">
                <form method="GET" action="{{route('backend.cashier.ordercart.addToCart')}}" id="#add-form-kilo">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
